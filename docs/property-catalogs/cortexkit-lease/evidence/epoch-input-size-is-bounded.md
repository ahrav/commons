...
- **Existing evidence:** `invalid_epoch_states_fail_closed` exercises a 21-byte file through ordinary and floor-based acquisition (`crates/cortexkit-lease/src/lib.rs:646-691`).
