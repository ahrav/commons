...
- **Open-question log:** mixed-version overlap policy is not documented. The versioning rule remains at `README.md:42-51`; `cortexkit-lease/Cargo.toml:2-3` records version `0.2.0`, with no path-derivation change in this update.
