...
- **Primary evidence:** documented race at `docs/lease-store-density.md:22-24`; both acquisition methods retain descriptor-bound locks after `open_lease_file` returns.
