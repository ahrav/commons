...
- **Primary evidence:** `docs/lease-store-density.md:3-42` reports 20,484 files, about 2.9 MiB/day physical growth, a 1 GiB trigger, and named watchers.
- **Implementation evidence:** one deterministic file per distinct key (`src/lib.rs:204-210`) and no production unlink.
