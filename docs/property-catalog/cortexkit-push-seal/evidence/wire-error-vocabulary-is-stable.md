...
- Code trail: mapping rationale and implementation in [`src/lib.rs`](../../../../crates/cortexkit-push-seal/src/lib.rs); [`every_open_failure_maps_to_the_wire_vocabulary`](../../../../crates/cortexkit-push-seal/src/lib.rs) and [`open_error_precedence_is_stable`](../../../../crates/cortexkit-push-seal/src/lib.rs).
