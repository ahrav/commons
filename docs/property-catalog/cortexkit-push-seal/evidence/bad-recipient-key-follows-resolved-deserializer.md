...
- Investigation log: the resolved `hpke 0.14.0` length behavior and local mapping are audited. This does not establish an independent X25519 validity policy.
