...
- Code trail: recipient key input, private-key parsing, and opening in [`src/lib.rs`](../../../../crates/cortexkit-push-seal/src/lib.rs); [`the_wrong_recipient_cannot_open`](../../../../crates/cortexkit-push-seal/src/lib.rs#L338).
